  ...
  return (
    <footer className="bg-primary text-center text-white">
      <div className="p-4 pb-0">
        <section className="mb-4 flex w-full flex-row flex-wrap justify-center gap-2 text-white">
          {/* LinkedIn */}
          <Link
            href="https://www.linkedin.com/in/tobiazamo/"
            target="_blank"
      ...
      <div className="p-3 text-center" style={{ backgroundColor: 'rgba(0, 0, 0, 0.2)' }}>
        © 2025 Copyright:
        <Link className="text-white" href="https://www.linkedin.com/in/tobiazamo/">
          {' '}
          Tobia Zamò
        </Link>
      </div>
